...
```
This time around, the model does a better job of estimating the true counts:
...
```{r plot-interactions, fig.height = 8, fig.width = 6, dpi = 200, fig.align = "center", class.output = "full-width"}
